let sayings = {
  ...
  cloudy: ['I Love Clouds! I Love Colleen!'],
  rain: [
  ...
  sleet: ['SLEET! What The! Ahh, who cares, because I Love Colleen Davis!'],
  snow: [
...
var randomPartlyCloudyDay = Math.floor(
  Math.random() * sayings.partlyCloudyDay.length
);
var randomPartlyCloudyNight = Math.floor(
  Math.random() * sayings.partlyCloudyNight.length
);
    ...
    switch (data.forecast.forecast) {
      ...
      case 'Mostly Sunny':
        $('body')
          ...
          .addClass('clear-day');
        $('#icon').html(
          "<img src='http://icons.wxug.com/i/c/v4/mostlysunny.svg'>"
        );
        $('.message').text(sayings.clear[randomClear]);
        break;
      ...
      case 'Partly Sunny':
        $('body')
          ...
          .addClass('clear-day');
        $('#icon').html(
          "<img src='http://icons.wxug.com/i/c/v4/partlysunny.svg'>"
        );
        $('.message').text(sayings.clear[randomClear]);
        break;
      ...
      case 'Scattered Clouds':
        $('body')
          .removeClass()
          .addClass('mostly-cloudy-day');
        $('#icon').html(
          "<img src='http://icons.wxug.com/i/c/v4/mostlycloudy.svg'>"
        );
      ...
      case 'Partly Cloudy':
        $('body')
          ...
          .addClass('mostly-cloudy-day');
        $('#icon').html(
          "<img src='http://icons.wxug.com/i/c/v4/partlycloudy.svg'>"
        );
        $('.message').text(sayings.partlyCloudyDay[randomPartlyCloudyDay]);
        break;
